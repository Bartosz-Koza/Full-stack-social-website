...
import EditOutlinedIcon from "@mui/icons-material/EditOffOutlinedIcon"
...
const Form = () =>{
    ...
    const handleFormSubmit = async(values,onSubmitProps) =>{
        if(isLogin) await loginShema(values, onSubmitProps);
        ...
        <form onSubmit={handleSubmit}>
            ...
            <Box>
                ...
                sx={{
                    ...
                    "& hover" : {collor: palette.primary.main},
                }}
                >
                ...
                >
                    {isLogin ? "FONT HAVE ACCOUNT ? SIGN UP" : "ALREADY HAVE AN ACCOUNT ? LOGIN HERE"}
                </Typography>
            </Box>
        </form>
    )}
